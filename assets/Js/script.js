...
let elementoButton = document.querySelector('#alterar') /* Cria a variável elementoBtn e coloca o elemento com o id alterar nela */
...
/* Verifica se o valour do botão é 'primeiro', se for troque de humor para segunda */
    if(elementoButton.value == 'primeiro'){
        ...
        elementoNome.innerText = 'Sr Madruga na Segunda-feira' /* Altera o texto do elemento nome */
        elementoSituacao.innerText = 'Segunda Feira' /* Altera o texto do elemento situação */
        ...
        elementoSituacao.innerText = 'Terça Feira' /* Altera o texto do elemento situação */
        ...
        elementoSituacao.innerText = 'Quarta Feira' /* Altera o texto do elemento situação */
        ...
        elementoSituacao.innerText = 'Quinta Feira' /* Altera o texto do elemento situação */
        ...
        elementoSituacao.innerText = 'Sexta Feira' /* Altera o texto do elemento situação */
        ...
        elementoSituacao.innerText = 'Sabado' /* Altera o texto do elemento situação */
    ...
    elementoSituacao.innerText = 'Domingo'
